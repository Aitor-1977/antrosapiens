...
def test_filtro_por_escala(db):
    ...
    # 10 corporativos históricos + 4 agregados 2026-09-10 (Banorte, HSBC
    # México, Oracle, Maersk — detectados como Startup en /expedientes por no
    # tener fila estructural) + 7 reclasificados desde Startup por estatus de
    # unicornio/consolidación (decisión del operador, 2026-08-22).
    assert corp_grandes == 21
