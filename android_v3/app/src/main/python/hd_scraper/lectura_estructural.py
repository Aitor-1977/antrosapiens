...
MARCO_DEUDA: tuple[TipoDeuda, ...] = (
    TipoDeuda(
        ...
        marcadores=(
            ...
            "a tu manera", "tu camino", "protagonista de tu", "solo depende de ti",
            "en tus manos", "se tu propio jefe", "vive a tu manera", "tu al mando",
            # PT
            "voce decide", "voce escolhe", "controle total", "cada pessoa",
            "faca voce mesmo", "sem depender", "liberdade individual", "seja seu proprio",
            "do seu jeito", "protagonista da sua", "so depende de voce", "nas suas maos",
            "seja seu proprio chefe", "voce no comando",
        ),
    ...
    TipoDeuda(
        ...
        marcadores=(
            ...
            "paso a paso", "poco a poco", "metas a", "objetivos de largo",
            "vision a futuro", "sostenible en el tiempo", "cada dia un poco",
            # PT
            "a longo prazo", "planeje seu futuro", "planeje", "poupe para", "aposentadoria",
            "todo mes", "seu futuro financeiro", "planejamento",
            "passo a passo", "pouco a pouco", "metas de longo", "visao de futuro",
            "sustentavel no tempo",
        ),
    ...
    TipoDeuda(
        ...
        marcadores=(
            ...
            "sin bancos", "sin tramites", "sin burocracia", "sin salir de casa",
            "sin llamadas", "sin visitas", "sin ir a la sucursal",
            # PT
            ...
            "sem burocracia", "sem sair de casa", "sem ligacoes", "sem ir a agencia",
        ),
    ...
    TipoDeuda(
        ...
        marcadores=(
            ...
            "muy simple", "super facil", "tan facil como", "sin curva de aprendizaje",
            "no necesitas saber", "olvidate de lo complicado", "guia paso a paso",
            # PT
            ...
            "muito simples", "super facil", "sem curva de aprendizado", "voce nao precisa saber",
            "esqueca o complicado",
        ),
    ...
    TipoDeuda(
        ...
        marcadores=(
            ...
            "rompe el silencio", "deja la verguenza", "sin prejuicios", "sin que te juzguen",
            # PT
            "sem tabu", "quebre o estigma", "fale abertamente", "sem vergonha",
            "sem medo", "sem julgamentos", "sem culpa", "sem segredos",
            "quebre o silencio", "sem preconceitos", "sem ser julgado",
        ),
